...
const client = new faunadb.Client({
    secret: 'fnAE_hE3gqAAzadDVIMuzhcCM6PeEEtCy4SSiZ5l',
});

const COLLECTION = "ALPINISMO"
    ...
    getPorId: async (req, res) => {
        try {
            ...
            let persona = await client.query(
                q.Get(q.Ref(q.Collection('ALPINISMO'), req.params.idPersona))
            )
